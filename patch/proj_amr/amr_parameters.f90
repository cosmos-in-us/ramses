...
!GILEE
  ...
  real(dp)::dr_refine_pkpc=1.0D0 ! Target resolution matching with cell size at the current highest level
  real(dp),dimension(1:MAXLEVEL)::m_refine_basic=-1 ! Lagrangian threshold defualt
!GILEE
