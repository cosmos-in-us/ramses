...
!GILEE
     if(holdback)then
        ...
        ! Sub-Lagrangian refinement based on target physical resolution (dr_refine_pkpc)
        dr_min_ckpc = dr_refine_pkpc * 0.8 / aexp ! this factor (0.8) can be changed
        boxlen_ckpc = boxlen_ini * 1D5 / h0
